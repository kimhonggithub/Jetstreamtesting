<div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $user ->email }}</td>
                                        <td>
                                            <a href="" wire:click.prevent="edit({{ $user }})"><i
                                                    class="fa fa-edit mr-4"></i></a>
    ...
    <!-- Modal -->
    <div class="modal fade" id="form" tabindex="-1" aria-labelledby="exampleModalLabel" role="dialog" aria-hidden="true"
        wire:ignore.self>
    ...
    <!-- Modal -->
    <div class="modal fade" id="confirmationModal" tabindex="-1" aria-labelledby="exampleModalLabel" role="dialog" aria-hidden="true"
        wire:ignore.self>
        <div class="modal-dialog" role="document">
            <dev class="modal-content">
                <div class="modal-header">
                    <h5>Delete User</h5>
                </div>
                <div class="modal-body">
                ...
                <button type="button" class="btn btn-danger " wire:click.prevent="deleteUser"><i class="fa fa-trash mr-2"></i>Delete</button>
                </div>
            </dev>
        </div>
    </div>
